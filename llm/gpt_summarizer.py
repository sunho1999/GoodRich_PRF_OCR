...
5. {product2_label}이 리모델링 상품이라고 간주하고, 고객 입장에서 어떤 상품이 더 합리적인 선택인지 객관적으로 제시하고,
...
- 결과를 **요약 → 공통 담보 비교표 → 리모델링 전용 담보 표** 순서로 작성하세요.
